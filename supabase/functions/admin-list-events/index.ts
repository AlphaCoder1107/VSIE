// @ts-nocheck
// Supabase Edge Function: admin-list-events
// Admin-only: returns the list of seminar events from public.seminar_events
...
serve(async (req: Request) => {
  ...
  let q = supabaseAdmin.from('seminar_events').select('slug, name, price_paise, active, created_at')
